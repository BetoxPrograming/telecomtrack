...
INSERT INTO material (
    ...
    (
        'CAB-UTP-001',
        'Cable UTP Cat6',
        'Cable de red categoría 6 para instalaciones internas',
        'metros',
        0,
        50,
        1,
    ...
    (
        'CON-RJ45-001',
        'Conector RJ45',
        'Conector RJ45 macho para cable UTP',
        'unidades',
        0,
        100,
        1,
    ...
    (
        'HER-CRI-001',
        'Crimpadora RJ45',
        'Herramienta para crimpar conectores RJ45',
        'unidades',
        0,
        2,
        2,
    ...
    (
        'EQP-SWT-001',
        'Switch 8 puertos',
        'Switch no administrable de 8 puertos Gigabit',
        'unidades',
        0,
        3,
        3,
...
WHERE codigo_unico = 'CAB-UTP-001';

UPDATE material
SET stock_actual = 500
WHERE codigo_unico = 'CON-RJ45-001';

UPDATE material
SET stock_actual = 5
WHERE codigo_unico = 'HER-CRI-001';