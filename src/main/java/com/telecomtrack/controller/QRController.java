...
public class QRController {
    ...
    public void generarQr(@PathVariable Integer idHerramienta, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String urlBase = request.getRequestURL().toString().replace("/qr/herramienta/" + idHerramienta, "");
        response.setContentType("image/png");
        qrCodeService.escribirQr(urlBase + "/qr/herramienta/" + idHerramienta + "/ficha", response.getOutputStream());
    }
    ...
    public String ficha(@PathVariable Integer idHerramienta, Model model) {
        ...
        AsignacionHerramienta ultimaAsignacion = devolucionHerramientaService.getUltimaAsignacionHerramienta(idHerramienta);
        List<DevolucionHerramienta> historialReciente = devolucionHerramientaService.getHistorialRecienteHerramienta(idHerramienta);
